...
export default function PolicyContent({ settings }: { settings: SiteSettingsDTO | null }) {
  const { i18n, t } = useTranslation();
  const lang = (i18n.language || "ru").slice(0, 2) as "ru" | "kk" | "en";

  const { html, docxUrl } = useMemo(() => {
    const html = (settings?.privacyPolicy as any)?.[lang] as string | null | undefined;
    const docx = (settings?.privacyPolicyDocUrls as any)?.[lang] as string | null | undefined;
  ...
  if (docxUrl) {
    if (loading) return (
      <div className="legal-doc">
        <div className="skeleton dark skel-line xl" style={{ width: "62%" }} />
        <div className="skel-gap" />
        <div className="skeleton dark skel-line xl" style={{ width: "100%" }} />
        <div className="skel-gap" />
        <div className="skeleton dark skel-line xl" style={{ width: "94%" }} />
        <div className="skel-gap" />
        <div className="skeleton dark skel-line xl" style={{ width: "88%" }} />
        <div className="skel-gap" />
        <div className="skeleton dark skel-line xl" style={{ width: "96%" }} />
        <div className="skel-gap" />
        <div className="skeleton dark skel-line xl" style={{ width: "72%" }} />
      </div>
    );
