      ...
      <div className="container grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="about-wrap">
          <div className="about-inner">
            ...
            <h3 id="aboutTeaserTitle" className="about-title">
              Lavender&nbsp;Travel — агентство с человеческим подходом
            </h3>

            <p className="about-lead">
              Подберём и забронируем всё «под ключ». Честные рекомендации,
              внимание к деталям и сопровождение на каждом шаге.
            </p>

            <ul className="about-points">
              <li><span className="dot" />Подбор и бронирование «под ключ»</li>
              <li><span className="dot" />Честные рекомендации без лишнего</li>
              <li><span className="dot" />На связи до вашего возвращения</li>
            </ul>

            <div className="about-cta">
              <Link href="/about" className="btn btn-primary press group" aria-label="Подробнее о компании">
                <span>Подробнее о нас</span>
                <svg className="icon transition-transform duration-200 ease-out group-hover:translate-x-1"
              ...
              <Link href={ig} target="_blank" className="btn btn-ghost press" aria-label="Мы в Instagram">
                Instagram
              </Link>
            </div>
          </div>
        ...
        <div className="about-photo">
          <img
            ...
            alt="Lavender Travel — атмосфера спокойного сервиса"
          ...
          <div className="about-note">
            <div className="about-note-text">
              <div className="about-note-title">Меньше шума — больше заботы</div>
              <div className="about-note-sub">Максимум внимания к вашему отдыху.</div>
            </div>

            <Link
              href={phoneHref}
              className="about-call-btn press"
              aria-label={`Звонок нам: ${phoneRaw}`}
            >
